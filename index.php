        ...
        <div class="w-50 card rounded-4 container shadow-lg m-0 p-0 overflow-hidden">
            <div class="row container-fluid m-0 p-0">
                ...
                <div class="left_panel m-0 p-5 col col-6">
                    <div class="py-5 m-0">
                        <img class="mb-4" src="pages/images/company.png" alt="OOSE Corporation Logo">
                        <h3 class="header_title">Employee<br>Attendance<br>System</h3>
                        <p class="footer_title mt-5">OOSE Corporation | All Rights Reserved</p>
                    </div>
                </div>
                <!-- Position selection -->
