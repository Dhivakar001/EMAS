<?php 
    ...
    $work_seconds = strtotime($row["work_hour"]) - strtotime("00:00:00");
    $work_hours = $work_seconds / 3600;

    $overtime_seconds = strtotime($row["overtime"]) - strtotime("00:00:00");
    $overtime_hours = $overtime_seconds / 3600;

    $salary = ($work_hours * $hour_rate) + ($overtime_hours * $hour_rate * 1.5);
}
                    if($row["am_in"]==null){
                        echo "<td>-</td>";
                        }
